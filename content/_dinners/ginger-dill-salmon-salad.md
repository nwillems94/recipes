---
title: "Ginger dill salmon salad"
layout: recipe
servings: "4"
ingredients:
  - name: "salmon, skin-on or skinless"
    quantity: "1"
    unit: "(1.5-lb) fillet"
  ...
  - name: "finely chopped dill"
    quantity: "6"
    unit: "tbsps"
  - name: "ginger, scrubbed and finely grated (no need to peel)"
    quantity: "1"
    unit: "(2-inch) piece"
  ...
  - name: "oranges"
    quantity: "2"
  - name: "radishes, cut into thin wedges"
    quantity: "6"
    unit: "small"
  - name: "avocado"
    quantity: "1"
...
Heat oven to 325°F. Line a sheet pan with parchment paper. Pat the salmon dry, then place on the tray skin-side down (if there is skin) and season with salt and pepper.
